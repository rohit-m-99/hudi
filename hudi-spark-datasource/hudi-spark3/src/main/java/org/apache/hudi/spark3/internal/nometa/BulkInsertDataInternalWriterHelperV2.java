...
import org.apache.hudi.io.HoodieRowCreateHandleV2;
 ...
 */
public class BulkInsertDataInternalWriterHelperV2 {

  private static final Logger LOG = LogManager.getLogger(org.apache.hudi.internal.BulkInsertDataInternalWriterHelper.class);
  ...
  private HoodieRowCreateHandleV2 handle;
  ...
  public BulkInsertDataInternalWriterHelperV2(HoodieTable hoodieTable, HoodieWriteConfig writeConfig,
  ...
  public void write(InternalRow record) throws IOException {
    try {
      ...
      String partitionPath = partitionFieldIndex != -1 ? record.getUTF8String(partitionFieldIndex).toString() : "";
  ...
  private void createNewHandle(String partitionPath) throws IOException {
    ...
    handle = new HoodieRowCreateHandleV2(hoodieTable, writeConfig, partitionPath, getNextFileId(),
