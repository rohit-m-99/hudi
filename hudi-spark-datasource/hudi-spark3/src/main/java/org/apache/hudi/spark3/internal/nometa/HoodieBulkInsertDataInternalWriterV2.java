 ...
 */
public class HoodieBulkInsertDataInternalWriterV2 implements DataWriter<InternalRow> {

  private final BulkInsertDataInternalWriterHelperV2 bulkInsertWriterHelper;

  public HoodieBulkInsertDataInternalWriterV2(HoodieTable hoodieTable, HoodieWriteConfig writeConfig,
                                              String instantTime, int taskPartitionId, long taskId, StructType structType,
                                              int partitionFieldIndex) {
    this.bulkInsertWriterHelper = new BulkInsertDataInternalWriterHelperV2(hoodieTable,
        writeConfig, instantTime, taskPartitionId, taskId, 0, structType, partitionFieldIndex);
  }
