 ...
 * of bulk insert.
 */
public class HoodieDataSourceInternalBatchWriteV2 implements BatchWrite {
  ...
  public HoodieDataSourceInternalBatchWriteV2(String instantTime, HoodieWriteConfig writeConfig, StructType structType,
                                              SparkSession jss, Configuration hadoopConfiguration, int partitionFieldIndex) {
  ...
  public DataWriterFactory createBatchWriterFactory(PhysicalWriteInfo info) {
    ...
    //if (WriteOperationType.BULK_INSERT_V2 == dataSourceInternalWriterHelper.getWriteOperationType()) {
    return new HoodieBulkInsertDataInternalWriterFactoryV2(dataSourceInternalWriterHelper.getHoodieTable(),
        writeConfig, instantTime, structType, partitionFieldIndex);
    /*} else {
