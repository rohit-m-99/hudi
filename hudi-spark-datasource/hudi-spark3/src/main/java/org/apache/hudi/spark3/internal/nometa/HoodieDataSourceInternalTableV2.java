 ...
 */
class HoodieDataSourceInternalTableV2 implements SupportsWrite {
  ...
  public HoodieDataSourceInternalTableV2(String instantTime, HoodieWriteConfig config,
                                         StructType schema, SparkSession jss, Configuration hadoopConfiguration, int partitionFieldIndex) {
  ...
  public WriteBuilder newWriteBuilder(LogicalWriteInfo logicalWriteInfo) {
    return new HoodieDataSourceInternalBatchWriteBuilderV2(instantTime, writeConfig, structType, jss,
