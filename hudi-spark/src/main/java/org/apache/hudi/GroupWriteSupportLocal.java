...
public class GroupWriteSupportLocal extends WriteSupport<Group> {
  ...
  public GroupWriteSupportLocal() {
    this(null, new HashMap<String, String>());
  }

  GroupWriteSupportLocal(MessageType schema) {
    this(schema, new HashMap<String, String>());
  }

  public GroupWriteSupportLocal(MessageType schema, Map<String, String> extraMetaData) {
    this.schema = schema;
