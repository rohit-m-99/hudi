...
/**
 * Execution plan for benchmarking
 */
...
public class WriteBenchmarkExecutionPlan {
  ...
  public void doSetup() throws Exception{
    try {
      ...
      List<HoodieRecord> recordsSoFar = new ArrayList<>(dataGen.generateInserts("001"/* ignore */, totalRecordsToTest));
      List<String> records1 = DataSourceTestUtils.convertToStringList(recordsSoFar);
      inputDF1 = spark.read().json(jssc.parallelize(records1, 100));
    } catch (IOException e) {
      e.printStackTrace();
