...
public class HoodieRowRecord<T> implements Serializable {
  ...
  private T orderingVal; // to avoid reading from byte[] and to avoid conversion to avro record, but couldn't make T extend Comprable. so need some work to be done.

  public HoodieRowRecord() {
  }

  HoodieRowRecord preCombine(HoodieRowRecord another) {
