 ...
 *
 */
public class SparkCompactHelpers<Row> extends
    AbstractCompactHelpers<Row, Dataset<Row>, Dataset<Row>, Dataset<HoodieInternalWriteStatus>> {
  ...
  @Override
  public HoodieCommitMetadata createCompactionMetadata(HoodieTable<Row, Dataset<Row>, Dataset<Row>, Dataset<HoodieInternalWriteStatus>> table,
                                                       String compactionInstantTime,
                                                        Dataset<HoodieInternalWriteStatus> writeStatuses,
    ...
    List<HoodieWriteStat> updateStatusMap = new ArrayList<>();
    for(HoodieInternalWriteStatus writeStatus: writeStatusList) {
      updateStatusMap.add(writeStatus.getStat());
    }
