...
public abstract class HoodieSparkTable<Row>
    extends HoodieTable<Row, Dataset<Row>, Dataset<Row>, Dataset<HoodieInternalWriteStatus>> {
  ...
  @Override
  protected HoodieIndex<Row, Dataset<Row>, Dataset<Row>, Dataset<HoodieInternalWriteStatus>> getIndex(HoodieWriteConfig config, HoodieEngineContext context) {
