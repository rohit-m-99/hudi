...
public class HoodieWriteResult implements Serializable {
  ...
  private Dataset<HoodieInternalWriteStatus> writeStatuses;
  private Map<String, List<String>> partitionToReplaceFileIds;

  public HoodieWriteResult(Dataset<HoodieInternalWriteStatus> writeStatuses) {
    this(writeStatuses, Collections.emptyMap());
  }

  public HoodieWriteResult(Dataset<HoodieInternalWriteStatus> writeStatuses, Map<String, List<String>> partitionToReplaceFileIds) {
    this.writeStatuses = writeStatuses;
    this.partitionToReplaceFileIds = partitionToReplaceFileIds;
  }

  public Dataset<HoodieInternalWriteStatus> getWriteStatuses() {
    return this.writeStatuses;
  }

  public void setWriteStatuses(final Dataset<HoodieInternalWriteStatus> writeStatuses) {
    this.writeStatuses = writeStatuses;
  }
