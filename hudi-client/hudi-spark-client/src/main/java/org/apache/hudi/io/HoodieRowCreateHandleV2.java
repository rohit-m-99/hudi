 ...
 */
public class HoodieRowCreateHandleV2 implements Serializable {
  ...
  public HoodieRowCreateHandleV2(HoodieTable table, HoodieWriteConfig writeConfig, String partitionPath, String fileId,
    ...
    this.writeStatus = new HoodieInternalWriteStatus(false,
  ...
  private HoodieInternalRowFileWriter createNewFileWriter(
      ...
      throws IOException {
    return HoodieInternalRowFileWriterFactory.getInternalRowFileWriterV2(
