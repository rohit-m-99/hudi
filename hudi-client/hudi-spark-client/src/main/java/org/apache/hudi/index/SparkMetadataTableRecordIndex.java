...
import org.apache.hudi.metadata.HoodieMetadataFileSliceUtil;
...
public class SparkMetadataTableRecordIndex extends HoodieIndex<Object, Object> {
  ...
  public <R> HoodieData<HoodieRecord<R>> tagLocation(HoodieData<HoodieRecord<R>> records, HoodieEngineContext context,
    ...
    try {
      ...
      numFileGroups = HoodieMetadataFileSliceUtil.getPartitionLatestMergedFileSlices(metaClient,
    ...
    JavaRDD<HoodieRecord<R>> y = HoodieJavaRDD.getJavaRDD(records)
        .keyBy(r -> HoodieMetadataFileSliceUtil.mapRecordKeyToFileGroupIndex(r.getRecordKey(), numFileGroups))
