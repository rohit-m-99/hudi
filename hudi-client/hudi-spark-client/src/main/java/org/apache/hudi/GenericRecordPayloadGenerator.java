 ...
 */
public class GenericRecordPayloadGenerator implements Serializable {

  private static final Logger LOG = LoggerFactory.getLogger(GenericRecordPayloadGenerator.class);
  ...
  public GenericRecordPayloadGenerator(Schema schema) {
    this(schema, DEFAULT_PAYLOAD_SIZE);
  }

  public GenericRecordPayloadGenerator(Schema schema, int minPayloadSize,
  ...
  public GenericRecordPayloadGenerator(Schema schema, int minPayloadSize) {
    Pair<Integer, Integer> sizeInfo = new GenericRecordPayloadSizeEstimator(schema).typeEstimateAndNumComplexFields();
  ...
  public static boolean isPrimitive(Schema localSchema) {
   ...
   */
  public GenericRecord randomize(GenericRecord record, Set<String> blacklistFields) {
   ...
   */
  public GenericRecord generateDeleteRecord(GenericRecord record) {
