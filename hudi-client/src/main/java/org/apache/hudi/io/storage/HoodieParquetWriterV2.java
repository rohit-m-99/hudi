...
public class HoodieParquetWriterV2<T extends HoodieRecordPayload, R extends IndexedRecord>
  ...
  private final ParquetWriteSupport writeSupport;
  private final String instantTime;
  private final Schema schema;
  private final SparkTaskContextSupplier sparkTaskContextSupplier;

  public HoodieParquetWriterV2(String instantTime, Path file, HoodieParquetConfig parquetConfig,
    ...
    this.writeSupport = new ParquetWriteSupport();
