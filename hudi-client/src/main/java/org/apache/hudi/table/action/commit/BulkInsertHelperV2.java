...
public class BulkInsertHelperV2<T extends HoodieRecordPayload<T>> {

  public static <T extends HoodieRecordPayload<T>> HoodieWriteMetadata bulkInsertV2(
      Dataset<HoodieRecord<T>> inputRecords, String instantTime,
    ...
    JavaRDD<HoodieRecord<T>> dedupedRecords = inputRecords.toJavaRDD();
